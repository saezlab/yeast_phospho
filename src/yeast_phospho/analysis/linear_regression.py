...
plt.savefig('%s/reports/linear_regression_loo_cv_gsea_steadystate.pdf' % wd, bbox_inches='tight')
plt.close('all')
...
g.fig.subplots_adjust(wspace=.05, hspace=.4)
sns.despine(trim=True)
plt.savefig('%s/reports/linear_regression_loo_cv_gsea_dynamic.pdf' % wd, bbox_inches='tight')
plt.close('all')
