...
g.add_legend()
plt.savefig('%s/reports/tf_activities_dynamic_nitrogen_tsplot_lm.pdf' % wd, bbox_inches='tight')
plt.close('all')
...
g.set_axis_labels('Time (minutes)', 'Activity')
g.add_legend()
plt.savefig('%s/reports/k_activities_dynamic_nitrogen_tsplot_lm.pdf' % wd, bbox_inches='tight')
plt.close('all')
print '[INFO] Corr plotted!'
...
# -- Dynamic combination
# Import
k_activity_comb_dyn = read_csv('%s/tables/kinase_activity_dynamic_combination.tab' % wd, sep='\t', index_col=0)
...
g.set_axis_labels('Time (minutes)', 'Activity')
g.add_legend()
plt.savefig('%s/reports/k_activities_dynamic_combination_tsplot_lm.pdf' % wd, bbox_inches='tight')
plt.close('all')
print '[INFO] Corr plotted!'
