...
datasets = [
    ...
    # # Linear regression
    # ('kinase_activity_steady_state', 'Kinases/Phosphatases', 'strain_relative_growth_rate.txt', 'Genetic perturbations'),
    # ('tf_activity_steady_state', 'TFs', 'strain_relative_growth_rate.txt', 'Genetic perturbations'),
    #
    # ('kinase_activity_dynamic', 'Kinases/Phosphatases', 'dynamic_growth.txt', 'Nitrogen metabolism'),
    # ('tf_activity_dynamic', 'TFs', 'dynamic_growth.txt', 'Nitrogen metabolism')
]
